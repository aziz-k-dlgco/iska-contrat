...
function Sidebar({ sidebarOpen, setSidebarOpen }) {
  ...
  // if click outside of sidebar, remove sidebar expanded class from body
  useEffect(() => {
  ...
  // on render, if sidebar is open, add sidebar expanded class to body
  useEffect(() => {
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              {/* Dashboard */}
              <SidebarLinkGroup activecondition={pathname.includes("contrat")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-slate-200 hover:text-white truncate transition duration-150 ${
                          pathname.includes("contrat") && "hover:text-slate-200"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded
