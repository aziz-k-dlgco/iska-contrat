...
let app =
    angular.module("adminApp", [])
        ...
        .controller("mainCtrl", ["$scope", "$http", "$timeout", "$log", function($scope, $http, $timeout, $log) {
            ...
            $scope.roles = [
                {id:0, lib:'ROLE_ADMIN'}, 
                {id:1, lib:'ROLE_JURIDIQUE'}, 
                {id:2, lib:'ROLE_USER_MANAGER'}, 
                {id:3, lib:'ROLE_USER_BOSS_JURIDIQUE'}, 
                {id:4, lib:'ROLE_USER'}, 
                {id:5, lib:'ROLE_JURIDIQUE2'}, 
                {id:6, lib:'ROLE_JURIDIQUE3'}, 
                {id:7, lib:'ROLE_JURIDIQUE4'}
            ];
                ...
                $http.post(baseURL + '/create_user', $scope.actualUser).then(
                    ...
                    function(response) {
                        ...
                        $scope.Toast.fire({
                            ...
                            text: 'Le compte ' + $scope.actualUser.email + ' a été créé. Son mot de passe est ' + response['data']['pass'] + '.',
                            time: 5000
                        });
                    },
                    //Erreur
