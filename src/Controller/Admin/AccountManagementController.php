 ...
 * @Route("/admin/acc_mgmt")
 */
class AccountManagementController extends AbstractController
{
    /**
     * @Route("/", name="app_admin_acc_mgmt_management")
     */
    ...
    /**
     * @Route("/list", name="app_admin_acc_mgmt_list")
     */
    ...
    /**
     * @Route("/list/departement", name="app_admin_acc_mgmt_list_departement")
     */
    ...
    /**
     * @Route("/update_user", name="app_admin_acc_mgmt_update_user")
     */
    ...
    /**
     * @Route("/create_user", name="app_admin_acc_mgmt_create_user")
     */
    ...
    /**
     * @Route("/update_password", name="app_admin_acc_mgmt_update_password")
     */
    public function update_password(Request $request, UserRepository $userRepository, UserPasswordHasherInterface $hasher, EntityManagerInterface $manager): JsonResponse
    {
        $json = json_decode(
            $request->getContent()
        );
